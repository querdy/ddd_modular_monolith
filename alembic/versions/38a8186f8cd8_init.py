...
Revision ID: 38a8186f8cd8
Revises: 
Create Date: 2025-07-23 05:33:03.917982
...
def upgrade() -> None:
    ...
    op.create_table('subproject_templates',
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.String(length=255), nullable=True),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('subproject_template_id')
    )
