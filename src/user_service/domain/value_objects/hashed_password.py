...
class HashedPassword(str):
    ...
    @classmethod
    def create(cls, plain_password: str, hasher: PasswordHasherProtocol = Argon2PasswordHasher()) -> Self:
    ...
    def verify(self, plain_password: str, hasher: PasswordHasherProtocol = Argon2PasswordHasher()) -> bool:
